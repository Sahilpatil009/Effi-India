...
export default async function RequestsPage() {
  ...
  return <CitizenShell><h1 className="text-3xl font-semibold">My requests</h1><p className="mt-3 text-slate-500">Follow your recent complaints and their current status.</p><LiveRequests userId={user.id} />
